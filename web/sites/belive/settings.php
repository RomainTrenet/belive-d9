 ...
 * @endcode
 */
$settings['hash_salt'] = $_SERVER['PROD_HASH'];
...
$databases['default']['default'] = array (
  'database' => $_SERVER['LOCAL_PROD_MYSQL_DATABASE'],
  'username' => $_SERVER['LOCAL_PROD_MYSQL_USERNAME'],
  'password' => $_SERVER['LOCAL_PROD_MYSQL_PASSWORD'],
  'prefix' => '',
  'host' => $_SERVER['LOCAL_PROD_MYSQL_HOSTNAME'],
  'port' => $_SERVER['LOCAL_PROD_MYSQL_PORT'],
