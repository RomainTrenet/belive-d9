...
$databases['default']['default'] = array (
    'database' => $_SERVER['PROD_MYSQL_DATABASE'],
    'username' => $_SERVER['PROD_MYSQL_USERNAME'],
    'password' => $_SERVER['PROD_MYSQL_PASSWORD'],
    'prefix' => '',
    'host' => $_SERVER['PROD_MYSQL_HOSTNAME'],
    'port' => $_SERVER['PROD_MYSQL_PORT'],
