 ...
 *   handlers = {
 *     "form" = {
 *       "add" = "Drupal\rt_registration\Form\RegistrationTypeForm",
 *       "edit" = "Drupal\rt_registration\Form\RegistrationTypeForm",
 *       "delete" = "Drupal\Core\Entity\EntityDeleteForm",
 *     },
 *     "list_builder" = "Drupal\rt_registration\RegistrationTypeListBuilder",
 *     "route_provider" = {
