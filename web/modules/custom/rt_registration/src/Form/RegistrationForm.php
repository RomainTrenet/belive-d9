  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('rt_registration')->notice('Created new registration %label', $logger_arguments);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The registration %label has been updated.', $message_arguments));
        $this->logger('rt_registration')->notice('Updated registration %label.', $logger_arguments);
        break;
    }
