...
/**
 * @file
 * Contains \Drupal\band_booking_performance\Guard\PerformanceGuard.
 */

namespace Drupal\band_booking_performance\Guard;
...
class PerformanceGuard implements GuardInterface {
